...
export type ActionRemoveTableRow = {
  type: typeof REMOVE_TABLE_ROW;
  payload: RemoveTableRowPayload;
};

export type RemoveTableRowPayload = {
  type: string;
  id: number;
};

export type ActionToggleSelectRow = {
  type: typeof TOGGLE_SELECT_ROW;
  payload: ToggleSelectRowPayload;
};

export type ToggleSelectRowPayload = {
  type: string;
  id: number;
};

export type ActionToggleHideColumn = {
  type: typeof TOGGLE_HIDE_COLUMN;
  payload: ToggleHideColumnPayload;
};

export type ToggleHideColumnPayload = {
  type: string;
  columnName: string;
};
