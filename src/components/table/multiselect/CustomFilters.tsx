  ...
  return (
    <div className="columns custom-filters">
      <div className="column col-6">
        <label className="menu-item-hover menu-item-block c-hand" onClick={onSelectAllFilters}>
          <i className="fas fa-check mr-2" />
          Выбрать все
        </label>
      </div>
      <div className="column col-6">
        <label className="menu-item-hover menu-item-block c-hand" onClick={onClearAllFilters}>
